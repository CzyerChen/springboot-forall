/**
 * Author:   claire
 * Date:    2021/12/18 - 5:18 下午
 * Description: 工具类
 * History:
 * <author>          <time>                   <version>          <desc>
 * claire          2021/12/18 - 5:18 下午          V1.0.0          工具类
 */
package com.learning.nacos.utils;

import com.learning.nacos.config.ILocalConfig;
 ...
 * @since 1.0.0
 */
public class LocalConfigTool {
    private static ILocalConfig config = SpringContextUtil.getBean(ILocalConfig.class);

    private LocalConfigTool() {
    }
