/**
 * Author:   claire
 * Date:    2021-03-02 - 09:50
 * Description: HDFS连接
 * History:
 * <author>          <time>                   <version>          <desc>
 * claire          2021-03-02 - 09:50          V1.17.0          HDFS连接
 */
...
public class KerberosWebHDFSConnection implements WebHDFSConnection {
    ...
    private AuthenticatedURL authenticatedURL = new AuthenticatedURL(new KerberosAuthenticator(principal, password));
    ...
    public KerberosWebHDFSConnection(String httpfsUrl, String principal, String password) {
        ...
        this.authenticatedURL = new AuthenticatedURL(new KerberosAuthenticator(principal, password));
    }

    public static synchronized AuthenticatedURL.Token generateToken(String srvUrl, String princ, String passwd) {
        AuthenticatedURL.Token newToken = new AuthenticatedURL.Token();
        try {

            HttpURLConnection conn = new AuthenticatedURL(new KerberosAuthenticator(princ, passwd)).openConnection(
